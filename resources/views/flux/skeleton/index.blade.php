...
@php
    ...
    $placeholderClasses = Flux::classes()
        ->add('h-4 w-full rounded-md bg-zinc-700/50')
...
>
    ...
    <flux:skeleton.group
        class="relative isolate overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:animate-[flux-shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-zinc-900/60 before:to-transparent before:opacity-70"
