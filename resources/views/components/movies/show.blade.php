...
new class extends Component {
    ...
    public function subscribe(): void
    {
        ...
        Flux::toast(text: __('lundbergh.toast.subscribed', ['title' => $this->movie->title]));
    }
    ...
    public function unsubscribe(): void
    {
        ...
        Flux::toast(text: __('lundbergh.toast.unsubscribed', ['title' => $this->movie->title]));
    }
...
<div class="flex flex-col">
    <x-media-hero :model="$movie" :title="$movie->title" :logo-url="$this->logoUrl">
        ...
        <x-slot:actions>
            @if ($this->isSubscribable)
                <x-subscribe-control :title="$movie->title" :mode="$this->mode" />
            @endif
    ...
    <div class="flex flex-col gap-8">
        @if ($movie->imdb_id)
            <livewire:movies.availability :movie="$movie" />
        @endif
    </div>
</div>
