    ...
    >
        ...
        >
            <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div
                    class="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ms-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-e-lg lg:rounded-s-none dark:bg-[#1D0002]"
                >
                    {{-- Laravel Logo --}}
                    <svg
