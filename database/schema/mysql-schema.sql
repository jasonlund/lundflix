...
CREATE TABLE `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `plex_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plex_token` text COLLATE utf8mb4_unicode_ci,
  `plex_username` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plex_thumb` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
