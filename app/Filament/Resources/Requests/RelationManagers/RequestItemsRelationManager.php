        ...
        return RequestItemsTable::configure($table)
            ->groupedBulkActions([
                BulkAction::make('markFulfilled')
                    ...
                    ->action(function (Collection $records, MarkRequestItems $markItems): void {
                        ...
                        $markItems->markAs($request, $recordIds, RequestItemStatus::Fulfilled, auth()->id());
                ...
                BulkAction::make('markRejected')
                    ...
                    ->action(function (Collection $records, MarkRequestItems $markItems): void {
                        ...
                        $markItems->markAs($request, $recordIds, RequestItemStatus::Rejected, auth()->id());
                ...
                BulkAction::make('markNotFound')
                    ...
                    ->action(function (Collection $records, MarkRequestItems $markItems): void {
                        ...
                        $markItems->markAs($request, $recordIds, RequestItemStatus::NotFound, auth()->id());
                ...
                BulkAction::make('markPending')
                    ...
                    ->action(function (Collection $records, MarkRequestItems $markItems): void {
                        ...
                        $markItems->markAs($request, $recordIds, RequestItemStatus::Pending);
