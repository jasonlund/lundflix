...
{
    /**
     * @param  array<int, array{imdb_id: string, tmdb_id: ?int, release_date: ?string, digital_release_date: ?string, original_language: ?string, original_title: ?string, status: ?string, origin_country: ?array, release_dates: ?array, tmdb_synced_at: string}>  $movies
     */
     ...
     * @return array{tmdb_id: int, release_date: ?string, digital_release_date: ?string, original_language: ?string, original_title: ?string, status: ?string, origin_country: ?array, release_dates: ?array}
     */
